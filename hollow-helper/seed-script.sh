...
seed_name="hollow-1"
root_dir="$(dirname "${0}")/.."
values_file="$root_dir/example/gardener-local/values.yaml"
bootstrap_token_file="$root_dir/example/gardener-local/secret-bootstrap-token.yaml"
garden_kubeconfig_file=/etc/kube/garden/garden-config
export KUBECONFIG=/etc/kube/hollow/hollow-config

ls /charts/gardener/gardenlet
